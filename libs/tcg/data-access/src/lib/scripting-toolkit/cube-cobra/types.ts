/**
 * Cube Cobra types for cube data.
 */

/**
 * Color values used in Cube Cobra.
 */
export type CubeCobraColor = 'W' | 'U' | 'B' | 'R' | 'G';

/**
 * Rarity values.
 */
export type CubeCobraRarity = 'common' | 'uncommon' | 'rare' | 'mythic' | 'special';

/**
 * Card details from Cube Cobra.
 */
...
/**
 * Card representation in a Cube Cobra cube.
 */
...
/**
 * Complete Cube Cobra cube representation.
 */
