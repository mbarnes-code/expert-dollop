/**
 * Color autocomplete data for the TCG data access layer.
 * Provides color identity autocomplete options for search.
 */

/**
 * Color autocomplete option type.
 */
export interface ColorAutocompleteOption {
  value: string;
  label: string;
  alias?: RegExp;
}
...
/**
 * Color autocomplete options for Magic: The Gathering color identities.
 */
export const colorAutocomplete: ColorAutocompleteOption[] = [
  {
    value: 'colorless',
    label: 'Colorless {c}',
  },
  ...
  // these are their own entries instead of
