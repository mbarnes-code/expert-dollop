/**
 * Task state management for the task runner.
 * Implements a finite state machine for task lifecycle.
 */
...
/**
 * Options for creating a task state.
 */
export interface TaskStateOpts {
  /** Unique identifier for the task */
  taskId: string;
  /** Timeout in seconds before the task is aborted */
  timeoutInS: number;
...
export class TaskState {
   ...
   * This implements a pattern-matching style approach for handling different states.
   *
   * @example
   * ```ts
   * taskState.caseOf({
