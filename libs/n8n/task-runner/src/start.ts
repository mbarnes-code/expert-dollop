/**
 * Entry point for starting the task runner.
 */
...
void (async function start() {
  ...
  // Set global state for timezone
  // In the actual implementation, this would call setGlobalState from n8n-workflow
  console.log(`Setting timezone: ${config.baseRunnerConfig.timezone}`);
