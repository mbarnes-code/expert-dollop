...
/**
 * Default search keys with weights for fuzzy searching
 */
 ...
 * @param target - string which is being searched
 * @returns a boolean which tells if pattern was found or not and a search score
 */
...
/**
 * Perform a sublime-style fuzzy search on a list of items
 * 
 * @param filter - The search filter string
 * @param data - The data to search through
 * @param keys - The keys to search with weights (default: DEFAULT_KEYS)
 * @returns Sorted array of matched items with scores
 * 
 * @example
 * ```ts
 * const results = sublimeSearch('user', items, [
 *   { key: 'name', weight: 1.5 },
